...
function SearchBar() {
    ...
    return (
        <div className=' absolute z-50 top-0  w-full bg-transperent sm:my-0 md:my-0   pt-7 mx-0 flex flex-col items-center justify-center '  >
            <div >
                ...
                <div className='flex bg-white w-[900px] sm:w-[300px] md:w-[375px] lg:w-[700px] items-center justify-between  rounded-xl shadow-2xl shadow-black' >
                    ...
                    {searchQuery ? <button type="submit" className='  w-[50px] sm:w-[25px] sm:mx-2 rounded-r-xl cursor-pointer' onClick={handleClick} > <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-x-lg" viewBox="0 0 16 16">
                        <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                    </svg> </button> : <button className='w-[50px] sm:w-[25px] sm:mx-2 rounded-r-xl '><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                    </svg></button>
                    }
                </div>
                {isOpen && <div > {
                    searchQuery ? <div ref={ref}  > {weatherData && <ul className='absolute w-[900px] sm:w-[300px] md:w-[375px] lg:w-[700px] px-5   mt-1  text-black text-lg lg:text-normal sm:text-sm md:text-base bg-white rounded-xl  placeholder:text-black'>
                        {
                            weatherData.map((weatherdata, index) => {
                                return (
                                    <div key={index} className=' z-50'  >
                                        <li className="py-3 sm:py-2 cursor-pointer list-none  " onClick={handleClick}  >
